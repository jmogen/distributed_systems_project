...
echo	 Examples:
echo $JAVA '-cp .:gen-java/:"lib/*":"jBCrypt-0.4/*" FENode 10776'
echo $JAVA '-cp .:gen-java/:"lib/*":"jBCrypt-0.4/*" BENode localhost 10776 10777'
echo $JAVA '-cp .:gen-java/:"lib/*":"jBCrypt-0.4/*" Client localhost 10776 hello'
echo --- For Executing Tester Script Run:
echo 'java -jar TesterClient-fat.jar 1 localhost localhost localhost'
echo 'java -jar TesterClient-fat.jar 2 localhost localhost localhost'
echo 'java -jar TesterClient-fat.jar 3 localhost localhost localhost'
echo 'java -jar TesterClient-fat.jar 4 localhost localhost localhost'
echo 'java -jar TesterClient-fat.jar 5 localhost localhost localhost'
echo 'java -jar TesterClient-fat.jar 6 localhost localhost localhost'
