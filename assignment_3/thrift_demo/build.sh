...
echo --- Compiling Java
$JAVA_CC -version
$JAVA_CC gen-java/*.java -cp .:"lib-java/*"
$JAVA_CC *.java -cp .:gen-java/:"lib-java/*"

echo --- Done, now run your code.
# $JAVA -cp .:gen-java/:"lib-java/*" JavaHsHaServer 10123
# $JAVA -cp .:gen-java/:"lib-java/*" JavaClient localhost 10123
