...
public class KeyValueHandler implements KeyValueService.Iface {
    ...
    @Override
    public void putWithVersion(String key, String value, long version) throws TException {
        // Simple implementation - just call regular put
        put(key, value);
    }
    ...
    @Override
    public void syncStateWithVersions(Map<String, String> state, Map<String, Long> versions) throws TException {
        // Simple implementation - just call regular syncState
        syncState(state);
    }
    ...
    @Override
    public Map<String, String> getCurrentStateWithVersions() throws TException {
